...
\begin{itemize}
	...
	\item[A1.1] ~\\
	      ...
	      \begin{itemize}
		      \item training set, assessing training error
		      \item test set, assessing performance through test error
		      \item validation set, assessing model selection through validation error
	      \end{itemize}
	      It visualizes the relationship between the model complexity and the error metrics.
	      Model complexity is intended as more hidden layers or neurons in the model.
